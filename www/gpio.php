...
if ($_REQUEST['progf2']) {
                               ...
                               $pf=fopen("/etc/cron.d/gpio21on","w");
                               fwrite($pf,$minini);
                               fwrite($pf,$tab);
                               fwrite($pf,$horaini);
                               fwrite($pf,$tab);
...
if ($_REQUEST['progf3']) {
                               exec("sudo /./home/elvis/permiso27.sh");
                               ...
                               $path="/home/elvis/on27.sh";
                               $pf=fopen("/etc/cron.d/gpio27on","w");
                               fwrite($pf,$minini);
                               fwrite($pf,$tab);
                               fwrite($pf,$horaini);
                               fwrite($pf,$tab);
                               ...
                               $path2="/home/elvis/off27.sh";
                               $pf2=fopen("/etc/cron.d/gpio27off","w");
                               fwrite($pf2,$minifin);
                               fwrite($pf2,$tab);
                               fwrite($pf2,$horafin);
                               fwrite($pf2,$tab); 
                               ...
                               fwrite($pf2,"\n");
                               fclose($pf2);
                               exec("sudo /home/elvis/nopermiso27.sh");
                              }
if ($_REQUEST['progf4']) {
                               exec("sudo /./home/elvis/permisocamara.sh");
                               ...
                               $path="/home/elvis/correo.sh";
                               $pf=fopen("/etc/cron.d/camara","w");
                               fwrite($pf,$minini);
                               fwrite($pf,$tab);
                               fwrite($pf,$horaini);
                               fwrite($pf,$tab);
                               ...
                               fwrite($pf,"\n");
                               fclose($pf);
                               exec("sudo /home/elvis/nopermisocamara.sh");
...
if ($_REQUEST['foto'])   {
                                   exec("sudo /./home/elvis/foto.sh 2>&1");
				   exec("sudo /./home/elvis/correo.sh 2>&1");
                                  }
